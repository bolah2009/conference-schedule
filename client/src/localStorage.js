    ...
    data: [
      {
        agendas: [
          ...
          {
            description:
              "Plant a memory, plant a tree, do it today for tomorrow.You can run, but you'll only die tired.It is not the responsibility of the language to force good looking code, but the language should make good looking code possible.Ungh. And I thought they smelled bad on the outside.",
          ...
          {
            description:
              "Smart people underestimate the ordinarity of ordinary people.Just for once, let me look on you with my own eyes.Imagine you are writing an email. You are in front of the computer. You are operating the computer, clicking a mouse and typing on a keyboard, but the message will be sent to a human over the internet. So you are working before the computer, but with a human behind the computer.Your hate has made you powerful. Now fulfill your destiny, take you're father's place by my side.",
      ...
      },
      {
        agendas: [
          {
            description:
              'Most of the tasks we do are for humans. For example, a tax calculation is counting numbers so the government can pull money out from my wallet, but government consists of humans.I have a bad feeling about...Often people, especially computer engineers, focus on the machines. But in fact we need to focus on humans, on how humans care about doing programming or operating the application of the machines.Remember your focus determines your reality.',
          ...
          {
            description:
              "Smart people underestimate the ordinarity of ordinary people.I have a bad feeling about...Because of the Turing completeness theory, everything one Turing-complete language can do can theoretically be done by another Turing-complete language, but at a different cost. You can do everything in assembler, but no one wants to program in assembler anymore.The Jedi are extinct. Their fire has gone out of the universe. You, my friend, are all that's left of their religion.",
      ...
      },
      {
        agendas: [
          {
            description:
              'Most of the tasks we do are for humans. For example, a tax calculation is counting numbers so the government can pull money out from my wallet, but government consists of humans.This deal is getting worse all the time.Most of the tasks we do are for humans. For example, a tax calculation is counting numbers so the government can pull money out from my wallet, but government consists of humans.You do have your moments. Not many, but you have them.',
      ...
      },
      {
        agendas: [
          ...
          {
            description:
              "Man is driven to create; I know I really love to create things. And while I'm not good at painting, drawing, or music, I can write software.It's not impossible. I used to bullseye womp rats in my T-16 back home, they're not much bigger than two meters.I believe consistency and orthogonality are tools of design, not the primary goal in design.You know, that little droid is going to cause me a lot of trouble.",
